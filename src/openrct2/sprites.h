...
enum : ImageIndex
{
    ...
    SPR_G2_SPINNING_TRACK_DIAG_BLOCK_BRAKES = SPR_G2_SPINNING_TRACK_DIAG_BRAKES + 4,
    ...
    SPR_G2_SPINNING_TRACK_SMALL_CURVE = SPR_G2_SPINNING_TRACK_VERTICAL + 12,
    ...
    SPR_G2_SPINNING_TRACK_HALF_LOOP = SPR_G2_SPINNING_TRACK_INLINE_TWIST + 128,
