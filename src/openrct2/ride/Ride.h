...
enum
{
    ...
    RIDE_ENTRY_FLAG_ALTERNATIVE_ROTATION_MODE_1_DEPRECATED = 1 << 5,
    // Lifting arm rotation ride (enterprise)
    RIDE_ENTRY_FLAG_ALTERNATIVE_ROTATION_MODE_2_DEPRECATED = 1 << 6,
    // union of the two alternative rotation modes
    RIDE_ENTRY_FLAG_ALTERNATIVE_ROTATION_MODES = 3 << 5,
