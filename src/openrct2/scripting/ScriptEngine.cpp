...
void ScriptEngine::RegisterConstants()
{
    ...
    builder.Namespace("TrackSlope")
        ...
        .Constant("Up42", EnumValue(TrackPitch::Up42))
        .Constant("Up60", EnumValue(TrackPitch::Up60))
        .Constant("Down12", EnumValue(TrackPitch::Down12))
        .Constant("Down25", EnumValue(TrackPitch::Down25))
        .Constant("Down42", EnumValue(TrackPitch::Down42))
        .Constant("Down60", EnumValue(TrackPitch::Down60))
        .Constant("Up75", EnumValue(TrackPitch::Up75))
        .Constant("Up90", EnumValue(TrackPitch::Up90))
        .Constant("Up105", EnumValue(TrackPitch::Up105))
        .Constant("Up120", EnumValue(TrackPitch::Up120))
        .Constant("Up135", EnumValue(TrackPitch::Up135))
        .Constant("Up150", EnumValue(TrackPitch::Up150))
        .Constant("Up165", EnumValue(TrackPitch::Up165))
        .Constant("Inverted", EnumValue(TrackPitch::Inverted))
        .Constant("Down75", EnumValue(TrackPitch::Down75))
        .Constant("Down90", EnumValue(TrackPitch::Down90))
        .Constant("Down105", EnumValue(TrackPitch::Down105))
        .Constant("Down120", EnumValue(TrackPitch::Down120))
        .Constant("Down135", EnumValue(TrackPitch::Down135))
        .Constant("Down150", EnumValue(TrackPitch::Down150))
        .Constant("Down165", EnumValue(TrackPitch::Down165))
        .Constant("UpRightCorkscrew0", EnumValue(TrackPitch::UpRightCorkscrew0))
        .Constant("UpRightCorkscrew1", EnumValue(TrackPitch::UpRightCorkscrew1))
        .Constant("UpRightCorkscrew2", EnumValue(TrackPitch::UpRightCorkscrew2))
        .Constant("UpRightCorkscrew3", EnumValue(TrackPitch::UpRightCorkscrew3))
        .Constant("UpRightCorkscrew4", EnumValue(TrackPitch::UpRightCorkscrew4))
        .Constant("DownRightCorkscrew0", EnumValue(TrackPitch::DownRightCorkscrew0))
        .Constant("DownRightCorkscrew1", EnumValue(TrackPitch::DownRightCorkscrew1))
        .Constant("DownRightCorkscrew2", EnumValue(TrackPitch::DownRightCorkscrew2))
        .Constant("DownRightCorkscrew3", EnumValue(TrackPitch::DownRightCorkscrew3))
        .Constant("DownRightCorkscrew4", EnumValue(TrackPitch::DownRightCorkscrew4))
        .Constant("UpLeftCorkscrew0", EnumValue(TrackPitch::UpLeftCorkscrew0))
        .Constant("UpLeftCorkscrew1", EnumValue(TrackPitch::UpLeftCorkscrew1))
        .Constant("UpLeftCorkscrew2", EnumValue(TrackPitch::UpLeftCorkscrew2))
        .Constant("UpLeftCorkscrew3", EnumValue(TrackPitch::UpLeftCorkscrew3))
        .Constant("UpLeftCorkscrew4", EnumValue(TrackPitch::UpLeftCorkscrew4))
        .Constant("DownLeftCorkscrew0", EnumValue(TrackPitch::DownLeftCorkscrew0))
        .Constant("DownLeftCorkscrew1", EnumValue(TrackPitch::DownLeftCorkscrew1))
        .Constant("DownLeftCorkscrew2", EnumValue(TrackPitch::DownLeftCorkscrew2))
        .Constant("DownLeftCorkscrew3", EnumValue(TrackPitch::DownLeftCorkscrew3))
        .Constant("DownLeftCorkscrew4", EnumValue(TrackPitch::DownLeftCorkscrew4))
        .Constant("UpLargeHalfHelix", EnumValue(TrackPitch::UpLargeHalfHelix))
        .Constant("UpSmallHalfHelix", EnumValue(TrackPitch::UpSmallHalfHelix))
        .Constant("DownLargeHalfHelix", EnumValue(TrackPitch::DownLargeHalfHelix))
        .Constant("DownSmallHalfHelix", EnumValue(TrackPitch::DownSmallHalfHelix))
        .Constant("UpLargeQuarterHelix", EnumValue(TrackPitch::UpLargeQuarterHelix))
        .Constant("DownLargeQuarterHelix", EnumValue(TrackPitch::DownLargeQuarterHelix))
        .Constant("Up8", EnumValue(TrackPitch::Up8))
        .Constant("Up16", EnumValue(TrackPitch::Up16))
        .Constant("Up50", EnumValue(TrackPitch::Up50))
        .Constant("Down8", EnumValue(TrackPitch::Down8))
        .Constant("Down16", EnumValue(TrackPitch::Down16))
        .Constant("Down50", EnumValue(TrackPitch::Down50))
        .Constant("Down25Inverting", EnumValue(TrackPitch::Down25Inverting))
    ...
    builder.Namespace("TrackBanking")
        ...
        .Constant("Right45", EnumValue(TrackRoll::Right45))
        .Constant("Left67", EnumValue(TrackRoll::Left67))
        .Constant("Left90", EnumValue(TrackRoll::Left90))
        .Constant("Left112", EnumValue(TrackRoll::Left112))
        .Constant("Left135", EnumValue(TrackRoll::Left135))
        .Constant("Left157", EnumValue(TrackRoll::Left157))
        .Constant("Right67", EnumValue(TrackRoll::Right67))
        .Constant("Right90", EnumValue(TrackRoll::Right90))
        .Constant("Right112", EnumValue(TrackRoll::Right112))
        .Constant("Right135", EnumValue(TrackRoll::Right135))
        .Constant("Right157", EnumValue(TrackRoll::Right157))
        .Constant("UpsideDown", EnumValue(TrackRoll::UpsideDown))
        .Constant("InvertedLeft22", EnumValue(TrackRoll::InvertedLeft22))
